...
export default function CreateDoerModal({
  ...
  // PC isn't offered here — it's not a separate account type, just a role you
  // promote an existing Doer to from the table below.
  const [role, setRole] = useState<Doer["role"]>("Doer");
