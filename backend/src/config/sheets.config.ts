...
export const sheetsConfig = {
  ...
  users: entity(
    ...
    "Doer ID",
    {
      ...
      "Can Delete Task": "can_delete_task",
      "Can Manage Doers": "can_manage_doers",
      "Can View Team Performance": "can_view_team_performance",
      "Can Edit Attendance": "can_edit_attendance",
